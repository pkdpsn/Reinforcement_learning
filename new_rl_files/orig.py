...
def main():
    ...
    i = 0
    model = DQN("MultiInputPolicy", env, batch_size=64, gamma=0.7, learning_rate=0.001, buffer_size=100000,
                learning_starts=1000, target_update_interval=1000, train_freq=4, verbose=1, tensorboard_log=logdir,
                policy_kwargs={"features_extractor_class": CustomCombinedExtractor, "activation_fn": th.nn.ReLU, "net_arch": [256, 256]})
